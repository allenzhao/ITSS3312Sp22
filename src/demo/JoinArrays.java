...
public class JoinArrays {
	...
	public static void main(String[] args) {
		...
		System.out.println("The temperatures on Monday were: " + Arrays.toString(mondayTemperatures));
		System.out.println("The temperatures on Tuesday were: " + Arrays.toString(tuesdayTemperatures));

		double[] earlyWeekTemperatures = joinArrays(mondayTemperatures, tuesdayTemperatures);

		System.out.println("The temperatures on Monday and Tuesday were: " + Arrays.toString(earlyWeekTemperatures));
	}
